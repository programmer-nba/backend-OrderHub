...
const flash_B = require ('../Controllers/deliveryController/FLASH_EXPRESS/Order(B)')
...
router.route('/orderhub/flash/canceled/notify').delete( auth.checkToken, flash.cancelNontification )
...
router.route('/orderhub/flash/webhook/route').post(flash.updateRouteWebhookFlash)
router.route('/orderhub/flash/webhook/courier').post( flash.updateStatusCourier )
router.route('/orderhub/flash/set/webhook').post( authAdmin.checkToken, flash.setWebHook )
router.route('/orderhub/flash/check/webhook').post( authAdmin.checkToken, flash.checkWebhook )

//Flash(B) express
router.route('/orderhub/flash/b/create').post( auth.checkToken, flash_B.createOrder )
router.route('/orderhub/flash/b/status').post( auth.checkToken, flash_B.statusOrder )
router.route('/orderhub/flash/b/getware').get( auth.checkToken, flash_B.getWareHouse )
router.route('/orderhub/flash/b/print180').post( auth.checkToken,flash_B.print100x180 )
router.route('/orderhub/flash/b/print75').post( auth.checkToken, flash_B.print100x75 )
router.route('/orderhub/flash/b/POD').get( auth.checkToken, flash_B.statusPOD )
router.route('/orderhub/flash/b/statusPack').get( auth.checkToken, flash_B.statusOrderPack )
router.route('/orderhub/flash/b/cancel').delete( auth.checkToken, flash_B.cancelOrder )
router.route('/orderhub/flash/b/notify').post( auth.checkToken, flash_B.notifyFlash )
router.route('/orderhub/flash/b/canceled/notify').delete( auth.checkToken, flash_B.cancelNontification )
router.route('/orderhub/flash/b/notification').get( auth.checkToken, flash_B.nontification )
router.route('/orderhub/flash/b/estimate').post( auth.checkToken, flash_B.estimateRate )
router.route('/orderhub/flash/b/getme').get( auth.checkToken, flash_B.getMeBooking )
router.route('/orderhub/flash/b/getById/:pno').get( auth.checkToken, flash_B.getById )
router.route('/orderhub/flash/b/webhook/status').post( flash_B.updateStatusWebhookFlash )
router.route('/orderhub/flash/b/webhook/route').post(flash_B.updateRouteWebhookFlash)
router.route('/orderhub/flash/b/webhook/courier').post( flash_B.updateStatusCourier )
router.route('/orderhub/flash/b/set/webhook').post( authAdmin.checkToken, flash_B.setWebHook )
router.route('/orderhub/flash/b/check/webhook').post( authAdmin.checkToken, flash_B.checkWebhook )
...
router.route('/orderhub/shippop/tracking').post( auth.checkToken, ship.tracking )
...
router.route('/orderhub/shippop/get/pickup').post( auth.checkToken, ship.getPickup )
router.route('/orderhub/shippop/cancel/pickup/:id').post( auth.checkToken, ship.cancelPickup )
...
router.route('/orderhub/JT_B/tracking').post( auth.checkToken,JT_B.trackingOrderJTB )
...
router.route('/orderhub/orderall/code/random').post( auth.checkToken, orderAll.getCodeRandom )
